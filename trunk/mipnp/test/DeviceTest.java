...
//         Assert.assertEquals("http://192.168.1.3:44444/mipnp/mipnp_cds.xml",contentDirectory.getDescriptionURL().toString());
...
//         Assert.assertEquals("http://192.168.1.3:44444/mipnp/mipnp_cms.xml",connectionManager.getDescriptionURL().toString());
...
//         
//         Assert.assertEquals("urn:schemas-upnp-org:service:ContentDirectory:1", contentDirectory.getType());
//         Assert.assertEquals("urn:upnp-org:serviceId:ContentDirectory", contentDirectory.getId());
//
//         //Test ConnectionManager
//         
//         Assert.assertEquals("urn:schemas-upnp-org:service:ConnectionManager:1", connectionManager.getType());
//         //...
//     }
//
//}